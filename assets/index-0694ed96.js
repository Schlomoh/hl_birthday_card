...
`,ke=u.forwardRef((e,n)=>{const{toggleModal:r,imageUrl:t}=e;return c.jsxs(Ye,{ref:n,children:[c.jsx(se,{modules:[_e],zoom:!0,children:c.jsxs(ae,{children:[c.jsx(T,{color:"white",style:{width:"100%",textAlign:"center"},children:"Double tap to zoom"}),c.jsx("div",{className:"swiper-zoom-container",children:t?c.jsx("img",{src:t,loading:"lazy",alt:"carousel_img_"+t}):c.jsx(T,{color:"grey",children:"Loading..."})})]},"img_"+t)}),c.jsx("div",{className:"button-container",children:c.jsx(Y.Provider,{value:{size:"50px",color:"white"},children:c.jsx(qe,{onClick:r})})})]})}),et=()=>{var i;const{loading:e,value:n}=Ce(Qe,[]),[r,t]=u.useState(0),s=u.useRef(null),o=()=>{var a,p;(a=s.current)!=null&&a.open?s.current.close():(p=s.current)==null||p.showModal()},d=a=>{t(a),o()},g=le(n?n[r]:"",(i=s.current)==null?void 0:i.open);return c.jsxs("main",{style:{position:"relative",zIndex:2,height:"100%"},children:[c.jsx(ke,{ref:s,imageUrl:G(g),toggleModal:o}),c.jsx(be,{children:c.jsx(Se,{gutter:"10px",style:{padding:"1rem"},children:e?c.jsx(c.Fragment,{}):n==null?void 0:n.map((a,p)=>c.jsx(Je,{onClick:()=>d(p),src:G(a),alt:"img_"+p,style:{borderRadius:"10px"}},"img_"+p))})}),c.jsx(T,{color:"grey",style:{padding:"2rem 1rem",textAlign:"center",width:"100%"},children:"Ihr könnt mir auch gerne bilder schicken die ich dann noch hinzufüge :)"})]})},W=u.createContext({}),tt=()=>{const[e,n]=u.useState(!1);return{isAuthenticated:e,setIsAuthenticated:n}},nt=({children:e})=>{const n=tt();return c.jsx(W.Provider,{value:n,children:e})},rt=b.div`
  ...
  justify-content: center;
  align-items: center;
`,it=()=>{const[e,n]=u.useState(""),{setIsAuthenticated:r,isAuthenticated:t}=u.useContext(W),s=o=>{n(o.target.value)};return u.useEffect(()=>{e==="1234567890"&&r(!0)},[e]),c.jsxs(rt,{children:[c.jsx(T,{color:"grey",children:"Enter the password"}),c.jsx("input",{type:"password",onChange:s,value:e})]})},ot=({children:e})=>{const{isAuthenticated:n}=u.useContext(W);return n?e:c.jsx(it,{})};function st(){const n=ve([{path:"/",element:c.jsx(ot,{children:c.jsx(et,{})})}],{basename:"/hl_birthday_card",window});return c.jsx(nt,{children:c.jsxs(Me,{children:[c.jsx(ze,{}),c.jsx(xe,{router:n})]})})}U.createRoot(document.getElementById("root")).render(c.jsx(st,{}));
